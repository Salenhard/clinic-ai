...
Задача: определи РАЗВИЛКИ алгоритмов всех методов лечения и их IF-THEN-ELSE правила.
...
- Факторы пациента спрашиваются всегда в начале
- Факторы пациента спрашиваются к каждому методу лечения
Верни СТРОГО JSON:
{{
  "algorithm": {{
